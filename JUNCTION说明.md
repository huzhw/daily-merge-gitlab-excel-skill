...
| 全局路径（junction，Qoder） | `C:\Users\Administrator\.qoder\skills\daily-merge-gitlab-excel` |
...
cmd /c dir "C:\Users\Administrator\.qoder\skills" | findstr daily-merge-gitlab-excel
```
...
rd "C:\Users\Administrator\.qoder\skills\daily-merge-gitlab-excel"
```
...
- 更名前 README、`templates/日报模板.xlsx` 以 F 仓库版本为准。